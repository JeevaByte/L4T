                   ...
                   <div className="form">
                      <form onSubmit={(e) => onSubmit(e)}>
                          <div className="form-controls">
                            <input type="text" placeholder='Enter Name' name="name" onChange={(e)=>onInputChange(e)}/>
                          </div>
                          <div className="form-controls">
                            <input type="text" placeholder='Enter Email Address' name="email" onChange={(e)=>onInputChange(e)}/>
                            {errorEmail && (
                          ...
                          <div className="form-controls">
                            <input type="password" placeholder='Enter Confirm Password' name="confirm_password" onChange={(e)=>onInputChange(e)}/>
                            {errorPwd && (
                              <p className="error"> {errorPwd} </p>
                            )}
                          </div>
                          <div className='d-flex justify-content-end form-controls'>
                            <button className='custom-btn login-btn'>Submit</button>
                          </div>
                      </form>
                   </div>
                </div>
